...
public class ListAllCarsActivity extends AppActivity implements AdapterView.OnItemClickListener {
    ...
    private void getData(Voiture voiture) {

        TextView textmarque = (TextView) findViewById(R.id.marque);
        textmarque.setText(voiture.getMarque());
        TextView textmodele = (TextView) findViewById(R.id.modele);
        textmodele.setText(voiture.getModele());
        TextView textenergie = (TextView) findViewById(R.id.energie);
        textenergie.setText(voiture.getEnergie().getEnergie().toString());
        TextView texttype = (TextView) findViewById(R.id.type);
        texttype.setText(voiture.getType().getType().toString());
